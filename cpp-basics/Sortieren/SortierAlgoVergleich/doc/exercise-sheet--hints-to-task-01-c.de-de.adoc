...
image::skills/uml/generated/UML__Denote_each_standalone_elementtyp_as_an_objecttyp.png[]
****
...
image::skills/uml/generated/UML__Denote_the_second_code_reading.png[]
...
Äußert sich die Core Guideline zur Nützlichkeit von Namensräumen?:::
****
